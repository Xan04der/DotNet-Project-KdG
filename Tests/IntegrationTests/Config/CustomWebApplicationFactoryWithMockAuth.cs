...
{ 
    ...
    { 
        ...
        { 
            var dbContextDescriptor = services.SingleOrDefault(
                d => d.ServiceType == 
                     typeof(DbContextOptions<ArtManagementDbContext>)); 
            ...
            services.AddDbContext<ArtManagementDbContext>((container, options) => 
            { 
    ...
    public WebApplicationFactory<TProgram> AuthenticatedInstance(params Claim[] 
        claimSeed) 
    { 
